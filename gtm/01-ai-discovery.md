...
structured-data guidance for software/app listings, not something schema.org itself validates —
I could not re-confirm the Google page this session (search was dead), so that string is
