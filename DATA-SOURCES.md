...
2. The moment you narrow to a category that actually has real business hours — restaurants —
   the true gap appears: **Munich is 85.5% covered, Jaipur is 8.9% covered.** That's a
...
and 1 GB/day**; a *regular application* (which this tool is) should target **1/100th of that —
roughly 100 queries and 10 MB/day**. Must send a `User-Agent` or `Referer` identifying the app.
